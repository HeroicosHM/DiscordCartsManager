...
This program is designed for the sneaker discord community to manage the various carts that might be used. This program is NOT a carts program, it is a cart MANAGER. This program will take the carts it finds in discord, format them with your group's branding, and only allow one person to claim them. To see detailed instructions on setup, there are tutorial videos linked below.
...
- [NEW - CyberAIO](https://cybersole.io/)
